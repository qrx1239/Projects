...
SELECT 
    YEAR(START) AS Year, COUNT(ID) AS 'Total Encounters'
FROM
    encounters
GROUP BY Year
ORDER BY Year DESC;
...
SELECT 
    ROUND(SUM(CASE
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Ambulatory_over_24hrs',
    ROUND(SUM(CASE
                WHEN TIMESTAMPDIFF(HOUR, START, STOP) < 24 THEN 1
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Ambulatory_under_24hrs',
    COUNT(*) AS num_encounters
FROM
    encounters;
...
SELECT 
    ...
    ROUND(SUM(CASE
                WHEN
                    ENCOUNTERCLASS = 'ambulatory'
                        AND TIMESTAMPDIFF(HOUR, START, STOP) >= 24
                THEN
                    1
                ELSE 0
            END) / COUNT(*) * 100,
    ...
    ROUND(SUM(CASE
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Outpatient_under_24hrs',
    ROUND(SUM(CASE
                WHEN
    ...
    ROUND(SUM(CASE
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Wellness_under_24hrs',
    ROUND(SUM(CASE
                WHEN
                    ENCOUNTERCLASS = 'urgentcare'
                        AND TIMESTAMPDIFF(HOUR, START, STOP) >= 24
                THEN
                    1
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Urgent_care_over_24hrs',
    ROUND(SUM(CASE
                WHEN
                    ENCOUNTERCLASS = 'urgentcare'
                        AND TIMESTAMPDIFF(HOUR, START, STOP) < 24
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Urgent_care_under_24hrs ',
    ROUND(SUM(CASE
                WHEN
    ...
    ROUND(SUM(CASE
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Emergency_under_24_hrs',
    ROUND(SUM(CASE
                WHEN
...
SELECT 
    ...
    ROUND(SUM(CASE
                ...
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Payers WITH Coverage',
    ROUND(SUM(CASE
                WHEN PAYER_COVERAGE = 0 THEN 1
                ELSE 0
            END) / COUNT(*) * 100,
            1) AS '% of Payers WITHOUT Coverage',
